...
public abstract class Editor extends JChangeDetectorPanel
{
	...
	private JComponent createHeader()
	{
		...
		scripting = createHeaderButton(CurrentLocale.get("com.dytech.edge.admin.wizard.editor.editor.scripting"),
			SCRIPT_ICON);

		final int[] rows = {titleLabel.getPreferredSize().height, errorMessage.getPreferredSize().height, 5,};
		final int[] cols = {10, TableLayout.FILL, 0, 0, 0,};
	...
	/**
	 * Loads the control by multiplexing out to one of the other loadFor*
	 * methods.
	 */
