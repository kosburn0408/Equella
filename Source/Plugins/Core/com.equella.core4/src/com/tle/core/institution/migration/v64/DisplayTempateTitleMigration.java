...
public class DisplayTempateTitleMigration extends AbstractHibernateDataMigration
{
	...
	{
		//Legacy string key
		return new MigrationInfo("com.tle.core.entity.services.migration.v64.displaytemplatetitle.title");
	}
				...
				while( iter.hasNext() )
				{
					...
					switch( configValue )
					{
						...
						case "commentsSection":
							InternalI18NString commentTitle = new KeyString(
								"com.tle.web.viewitem.summary.comments.addnew");
	...
	{
		LanguageString langstring = LangUtils.createLanguageString(null, CurrentLocale.getLocale(), title);
